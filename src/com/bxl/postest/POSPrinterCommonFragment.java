...
public class POSPrinterCommonFragment extends POSPrinterFragment
	...
	private static final String PREFS_NAME = "LogicalNamePrefsFile";
	...
	public View onCreateView(LayoutInflater inflater,
		...
		logicalNameEditText.setText(settings.getString(LOGICAL_NAME_KEY, getString(R.string.pos_printer)));
	...
	public void onDestroyView() {
		...
		editor.putString(LOGICAL_NAME_KEY, logicalNameEditText.getText().toString());
		editor.commit();
	}
